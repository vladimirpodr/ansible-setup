...
# your SSH keys and authorized_host files on, ex: 192.168.0.1
env.hosts = ['192.168.0.1']

# your full name for the new non-root user
env.new_user_full_name = 'Volodymyr Podrushnyak' # ex: Matt Makai
...
env.ssh_key_dir = '~/ansible-setup/ssh_keys'
